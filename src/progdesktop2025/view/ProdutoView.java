...
public class ProdutoView extends javax.swing.JFrame {
    ...
    private final int SEARCHINDEX = 2; // ID
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(fieldPreco, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private int procurarValor(int valor) {
        ...
        for (int linha = 0; linha < jTableModel.getRowCount(); linha++) {
            ...
            int valorAtual = (int) jTableModel.getValueAt(linha, this.SEARCHINDEX);
    ...
    private void jButtonSelecionarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonSelecionarMouseClicked
        ...
        int valor = this.procurarValor((int) valorVerificar);
        ...
        String preco = jTableModel.getValueAt(valor, 1).toString();

        this.fieldNome.setText(nome);
        this.fieldPreco.setText(preco);
